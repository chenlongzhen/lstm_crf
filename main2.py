...
flags.DEFINE_string("emb_file",     os.path.join(root_path+"datas", "vec.txt"),  "Path for pre_trained embedding")
flags.DEFINE_string("train_file",   os.path.join(root_path+"datas", "example2.train"),  "Path for train data")
flags.DEFINE_string("dev_file",     os.path.join(root_path+"datas", "example2.dev"),    "Path for dev data")
flags.DEFINE_string("test_file",    os.path.join(root_path+"datas", "example2.test"),   "Path for test data")
